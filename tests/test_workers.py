...
class TestProcessTranscriptUnit:
    ...
    def test_returns_expected_fields(self, eager_app) -> None:
    ...
    def test_raises_on_missing_transcript_id(self, eager_app) -> None:
    ...
    def test_raises_on_missing_user_id(self, eager_app) -> None:
    ...
    def test_user_id_echoed_in_result(self, eager_app) -> None:
    ...
    def test_transcript_id_echoed_in_result(self, eager_app) -> None:
        result = process_transcript.delay(
            transcript_id="t-xyz",
            user_id="u-abc",
            raw_text="content",
...
class TestGenerateBriefUnit:
    ...
    def test_raises_on_missing_conversation_id(self, eager_app) -> None:
    ...
    def test_conversation_id_echoed_in_result(self, eager_app) -> None:
        result = generate_brief.delay(
...
class TestProcessTranscriptIntegration:
    ...
    def test_task_dispatches_successfully(self, require_redis) -> None:
